        ...
        <div class="card mb-3" style="border-radius: .5rem;">
          <div class="row g-0 m-10" style="margin : 2rem">  
            <div class="col-6" style="text-align : center">
              <h3 class="m-4"> Enter your new password</h1>
              <input required="required" class="w-auto m-4 mt-0" id="pwd-1" type='password'> </input>
            </div>
          <div class="col-6" style="text-align : center">
            <h3 class="m-4 font-medium"> Confirm your new password </h1>
          ...
          confirmButton.onclick = async () =>
              {
                ...
                msg.innerHTML = "vous devez remplir les champs pour le mot de passe";
              }
              }
        };
